...
export interface Env {
  CLIENTCASA_API_KEY?: string | undefined;

  CLIENTCASA_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodMiniType<Env, unknown> = z.object({
  CLIENTCASA_API_KEY: z.optional(z.string()),

  CLIENTCASA_DEBUG: z.optional(z.coerce.boolean()),
});
