...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(operations.ListFormsRequest$outboundSchema), value),
  ...
  const path = pathToFunc("/api/v1/forms")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListFormsResponse$inboundSchema, { key: "Result" }),
