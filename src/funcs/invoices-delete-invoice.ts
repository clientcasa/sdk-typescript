 ...
 */
export function invoicesDeleteInvoice(
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.DeleteInvoiceRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/invoices/{id}")(pathParams);
