 ...
 */
export function formSubmissionsGet(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetFormSubmissionRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/form-submissions/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.FormSubmission$inboundSchema),
