 ...
 * List proposals
 */
export function formsAndAgreementsList(
  ...
  PageIterator<
    Result<
      operations.ListClientDocumentsResponse,
      | errors.ApiError
      | ClientCasaError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListClientDocumentsRequest$outboundSchema),
        value,
      ),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListClientDocumentsResponse$inboundSchema, {
      key: "Result",
    }),
