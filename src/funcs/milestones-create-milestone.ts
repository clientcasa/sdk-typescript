 ...
 */
export function milestonesCreateMilestone(
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.MilestoneCreate$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/milestones")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.Milestone$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
