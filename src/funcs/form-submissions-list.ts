...
export function formSubmissionsList(
  ...
  PageIterator<
    Result<
      operations.ListFormSubmissionsResponse,
      | errors.ApiError
      | ClientCasaError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListFormSubmissionsRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/form-submissions")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListFormSubmissionsResponse$inboundSchema, {
      key: "Result",
    }),
