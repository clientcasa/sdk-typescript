 ...
 * Get a proposal
 */
export function formsAndAgreementsGet(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetClientDocumentRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/client-documents/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ClientDocument$inboundSchema),
