 ...
 * List payouts
 */
export function payoutsListPayouts(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(operations.ListPayoutsRequest$outboundSchema), value),
  ...
  const path = pathToFunc("/api/v1/payouts")();

  const query = encodeFormQuery({
    "arrivalDateFrom": payload?.arrivalDateFrom,
    "arrivalDateTo": payload?.arrivalDateTo,
    "page": payload?.page,
