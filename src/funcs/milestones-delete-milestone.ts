 ...
 * Delete a milestone
 */
export function milestonesDeleteMilestone(
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.DeleteMilestoneRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/milestones/{id}")(pathParams);
