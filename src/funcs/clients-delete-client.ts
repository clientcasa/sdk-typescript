 ...
 * Delete a client
 */
export function clientsDeleteClient(
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.DeleteClientRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/clients/{id}")(pathParams);
