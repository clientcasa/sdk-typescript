...
```typescript
import { ListSalesResponse } from "@clientcasa/sdk/models/operations";

let value: ListSalesResponse = {
  result: {
    data: [
      {
...
| -------------------------------------------- | -------------------------------------------- | -------------------------------------------- | -------------------------------------------- |
| `result`                                     | [models.SaleList](../../models/sale-list.md) | :heavy_check_mark:                           | N/A                                          |