...
```typescript
import { CreateTimeEntryRequest } from "@clientcasa/sdk/models/operations";

let value: CreateTimeEntryRequest = {
...
| `body`                                                                                                                                                                                                      | [models.TimeEntryCreate](../../models/time-entry-create.md)                                                                                                                                                 | :heavy_check_mark:                                                                                                                                                                                          | N/A                                                                                                                                                                                                         |                                                                                                                                                                                                             |