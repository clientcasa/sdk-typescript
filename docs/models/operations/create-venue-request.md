...
```typescript
import { CreateVenueRequest } from "@clientcasa/sdk/models/operations";

let value: CreateVenueRequest = {
...
| `body`                                                                                                                                                                                                      | [models.VenueCreate](../../models/venue-create.md)                                                                                                                                                          | :heavy_check_mark:                                                                                                                                                                                          | N/A                                                                                                                                                                                                         |                                                                                                                                                                                                             |