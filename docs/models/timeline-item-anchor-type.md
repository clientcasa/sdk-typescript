...
```typescript
import { TimelineItemAnchorType } from "@clientcasa/sdk/models";

let value: TimelineItemAnchorType = "fixed";
...
```typescript
"none" | "fixed" | "fixed-end" | "ceremony" | "event-start" | "sunset" | "sunrise" | "custom-event" | Unrecognized<string>
```